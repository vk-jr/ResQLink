...
class _RegionDetailsScreenState extends State<RegionDetailsScreen> {
  ...
  Future<void> _loadMessages() async {
    try {
      print('Loading messages for region: ${widget.regionName}');
      ...
      print('Loaded messages: $response');
      setState(() {
            ...
            child: isLoading
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      print('Building message at index $index. Total messages: ${messages.length}');
                      final message = messages[messages.length - 1 - index];
                      final isNeedHelp = message['is_need_help'] == true;
                      final senderName = message['user_id'] ?? 'Anonymous';
